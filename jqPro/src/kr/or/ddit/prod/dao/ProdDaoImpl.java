...
import kr.or.ddit.prod.vo.ProdVO;
   ...
   /*
      ...
      SqlMapClient 객체가 필요하다
      
      daoImpl 클래스는 serviceImpl클래스에서 사용한다
      ㄴ 자신의 객체를 생성해서 리턴하는 메소드 - getXX
...
public class ProdDaoImpl implements IProdDao{
   ...
   //생성자 - private함으로서 다른 서비스에서 객체 생성(new)하지 않는다 => 싱글톤 방식
   private ProdDaoImpl() {
...
//      List<ProdVO> prodList = smc.queryForList("", prod_lgu);
//      return prodList;
